%% @author man
%% @doc @todo Add description to http_serv.
...
%% API functions
%% ====================================================================
-export([start_link/1,dispatch/1]).
...
dispatch(Req) ->
    ...
    case lists:keyfind("comm", 1, Args) of
                ...
                Comm2 when Comm2 =:= "1" orelse Comm2 =:= "2" ->
                    case ets:lookup(ets_user, UserId) of
                        [User] when is_record(User, user) ->
                            ...
                            case util:double_validate(User#user.time, util:seconds(), Req:get(peer), User#user.userIp) of
                                true ->
                                    Comm3 = case Comm2 of
                                                "1" -> pickclass;
                                                "2" -> dropclass
        ...
        _ ->
            Req:respond({200, Headers, "Request Not Allowed\r\n"}) 
    end.
